...
def generate_launch_description():
    ...
    pacsim_to_lart_bridge = Node(
            package='lart_to_pacsim_bridge',
            executable='lart_to_pacsim_bridge',
    ...
    car_to_basefootprint = Node(package="tf2_ros", executable="static_transform_publisher", arguments=["0", "0", "0", "0", "0", "0", "car", "base_footprint"])

    map_to_basefootprint = Node(package='tf2_ros', executable='static_transform_publisher', arguments=['0', '0', '0', '0', '0', '0', 'map', 'base_footprint'])
